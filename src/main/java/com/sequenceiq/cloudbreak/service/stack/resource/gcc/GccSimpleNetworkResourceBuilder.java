...
public abstract class GccSimpleNetworkResourceBuilder implements
    ...
    @Override
    public Boolean start(GccStartStopContextObject ssco, Resource resource, String region) {
        return true;
    }

    @Override
    public Boolean stop(GccStartStopContextObject ssco, Resource resource, String region) {
        return true;
    }

    @Override
    public Boolean rollback(Resource resource, GccDeleteContextObject gDCO, String region) throws Exception {
        return delete(resource, gDCO, region);
    }
